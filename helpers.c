...
float angleBtwn(int v1[], int v2[]){
	...
	float th = acos(dotprod(v1L,v2L)/sqrt(dotprod(v1L,v1L) * dotprod(v2L,v2L)));
	if(v1[0]<v2[0]) th = -th;
	//if(p2->x > p1->x) th = -th;
	//sprintf(buff,"dot prod  %d %d %ld %.0f  %.0f\n", v1[0],v2[0],v1L[0], dotprod(v1L,v2L),th);
	//sendBuffer(buff);
	return th;
}
long dotprod(long v1[], long v2[]){
	return v1[0]*v2[0]*1.f + v1[1]*v2[1]*1.f;
}
